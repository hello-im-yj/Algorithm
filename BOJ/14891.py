...
# def turn(idx,dir) :
#     if dir == 1 and 0<idx and idx<5 :
#         gear[idx].appendleft(gear[idx].pop())
#         if idx-1 > 0 and gear[idx-1][2] != gear[idx][7] : turn(idx-1,-1)
#         if idx+1 < 5 and gear[idx+1][6] != gear[idx][3] : turn(idx+1,-1)
#     elif dir == -1 and 0<idx and idx<5 :
#         gear[idx].append(gear[idx].popleft())
#         if idx-1 > 0 and gear[idx-1][2] != gear[idx][5] : 
#             print(gear[idx-1][2] != gear[idx][5])
#             print(gear[idx-1][2],gear[idx][5])
#             turn(idx-1,+1)
#         print("after :",gear)
#         if idx+1 < 5 and gear[idx+1][6] != gear[idx][1] : turn(idx+1,+1)
#     return 
